                ...
                <CardContent>
                  <form>
                    ...
                    <TextField
                      ...
                      placeholder="Enter your fathers occupation name"
                      type="text"
                    />
                    <br />
                    <br />
                    <TextField
                      fullWidth
                      label="Mothers name*"
                      placeholder="Enter your mothers name name"
                      type="text"
                    />
                    <br />
                    <br />
                    <TextField
                      ...
                      placeholder="Enter your mothers occupation name"
                      type="text"
                    />
                    <br />
                    <br />
                    {/* Slection of brothers. */}
                    <Grid
                      container
                      direction="row"
                      columnSpacing={2}
                    ...
                    <Grid container direction="row">
                      ...
                      <Grid item xs={12} sm={12} md={8} lg={8}>
                        ...
                        <Button variant="contained" style={{backgroundColor:"#645c60"}}>Previous</Button> &nbsp;
                          <Button variant="contained" style={{backgroundColor:"#DF3768"}}>Next</Button>
                        </center>
                      </Grid>
                      <Grid item xs={12} sm={12} md={2} lg={2}></Grid>
                    </Grid>
